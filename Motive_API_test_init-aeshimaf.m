...
%project_file = 'C:\Users\sorhirsh\OneDrive\work control lab aero summer 2014 technion\Car\CAR.ttp'; % change if necessary
...
if ~libisloaded('NPTrackingTools')
    ...
    [notfound,warnings]=loadlibrary('NPTrackingTools','NPTrackingTools.h','includepath','C:\Program Files\OptiTrack\Motive\inc')
end

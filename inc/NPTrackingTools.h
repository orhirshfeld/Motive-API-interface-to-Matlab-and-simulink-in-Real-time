...
TTAPI   NPRESULT TT_LoadTrackablesW(const wchar_t *filename); //== Load Trackables ===----
TTAPI   NPRESULT TT_LoadTrackables (const char *filename);
TTAPI   NPRESULT TT_SaveTrackablesW(const wchar_t *filename); //== Save Trackables ===----
TTAPI   NPRESULT TT_SaveTrackables (const char *filename);
TTAPI   NPRESULT TT_AddTrackablesW (const wchar_t *filename); //== Add  Trackables ===----
TTAPI   NPRESULT TT_AddTrackables  (const char *filename);
...
TTAPI   int      TT_TrackableUserData(int index);           //== Get Trackables User Data ===---
TTAPI   void     TT_SetTrackableUserData(int index,int ID); //== Set Trackables User Data ===---
TTAPI   const char*    TT_TrackableName (int index);        //== Returns Trackable Name =====---
TTAPI   const wchar_t* TT_TrackableNameW(int index);        //== Returns Trackable Name =====---
...
TTAPI   bool     TT_TrackableResetOrientation(int index);

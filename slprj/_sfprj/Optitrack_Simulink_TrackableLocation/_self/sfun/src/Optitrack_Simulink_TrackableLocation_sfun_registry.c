...
{
  extern unsigned int
    sf_Optitrack_Simulink_TrackableLocation_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Optitrack_Simulink_TrackableLocation_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Optitrack_Simulink_TrackableLocation_process_testpoint_info_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Optitrack_Simulink_TrackableLocation_process_testpoint_info_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_Optitrack_Simulink_TrackableLocation_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "Optitrack_Simulink_TrackableLocation") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Optitrack_Simulink_TrackableLocation_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Optitrack_Simulink_TrackableLocation_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Optitrack_Simulink_TrackableLocation") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Optitrack_Simulink_TrackableLocation_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_Optitrack_Simulink_TrackableLocation_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "Optitrack_Simulink_TrackableLocation") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Optitrack_Simulink_TrackableLocation_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Optitrack_Simulink_TrackableLocation") == 0) {
    ...
    newRhs[1] = prhs[2];
    return
      sf_Optitrack_Simulink_TrackableLocation_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_Optitrack_Simulink_TrackableLocation_method_dispatcher
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Optitrack_Simulink_TrackableLocation")) {
    return(sf_Optitrack_Simulink_TrackableLocation_method_dispatcher
...
extern void Optitrack_Simulink_TrackableLocation_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    Optitrack_Simulink_TrackableLocation_terminator();
...
extern void Optitrack_Simulink_TrackableLocation_initializer(void);
extern void Optitrack_Simulink_TrackableLocation_register_exported_symbols
  (SimStruct* S);
extern void Optitrack_Simulink_TrackableLocation_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Optitrack_Simulink_TrackableLocation_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      Optitrack_Simulink_TrackableLocation_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    Optitrack_Simulink_TrackableLocation_initializer();
  }
